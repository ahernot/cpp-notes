...
class Arete{
    ...
    public:
        ...
        void print_arete(); //afficher une arete sous forme textuelle
...
class Graphe_adj{
    ...
    public:
        Graphe_adj(std::map<std::string, std::vector<Arete>> sm): som{sm} {};
        ...
        std::map<std::string, std::vector<Arete>> get_som(); // vr: il doit retourner par référence pas par copie
